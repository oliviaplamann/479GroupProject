#!/bin/bash
mkdir -p slurm_out_month_r

jobId1=$(sbatch --array=1-3 \
       --output="slurm_out_month_r/slurm-%A_%a.out" \
       --error="slurm_out_month_r/slurm-%A_%a.err" \
       ./combine_months_2022.sh)
